...
async function CrearDBSiNoExiste() {
      ...
      if (!exists) {
            ...
            await db.run(
                  ...
                  (2, '2015-08-20', 'La calidad de la autora es excelente, aunque no mi estilo.', 3, 'user2'),
                  (3, '2010-11-10', 'No me gustó para nada. Asqueroso.', 1, 'user3'),
                  (4, '2018-03-25', 'Me encantó. Muy buen libro.', 4, 'user4'),
                  (5, '2011-09-05', 'Muy buen libro. Me gustó mucho.', 4, 'user5'),
                  (6, '2019-06-12', 'Este libro tiene mucho potencial. Ojalá llegara al New York Times', 5, 'user6'),
                  (7, '2014-10-30', 'Me encantó.', 4, 'user7'),
                  (8, '2012-07-18', 'Lo leí en un par de horas. Es fascinante.', 4, 'user8'),
                  (9, '2017-02-22', 'Como amante de los libros que soy, esta edición me ha decepcionado un poco pero respeto a la autora.', 3, 'user9'),
                  ...
                  (13, '2013-09-28', 'Me aburrio al principio y no terminé de leerlo.', 2, 'user8'),
                  ...
                  (19, '2014-06-30', 'Muy decepcionante, no me gusto', 1, 'user2'),
                  (20, '2020-02-19', 'Me encantó. Esplendido!!.', 4, 'user1'),
                  ...
                  (4, '2019-11-08', 'Me encantó todo, muy buen desarrollo.', 4, 'user2'),
                  (5, '2010-06-16', 'Muy buen libro. Me gustó mucho.', 4, 'user1'),
                  (6, '2012-04-04', 'Algunos tendrian que dejar de escribir...', 1, 'user10'),
                  (7, '2013-10-29', 'Me encantó. Un excelente libro.', 4, 'user9'),
                  (8, '2016-03-07', 'Me gustó y disfruté mucho.', 4, 'user8'),
                  (9, '2014-08-13', 'Lo peor que lei en mi vida.', 1, 'user7'),
                  ...
                  (13, '2012-10-12', 'No me gustó para nada. Esta muy mal escrito', 1, 'user4'),
                  (14, '2017-04-09', 'Disfrute mucho de leerlo.', 4, 'user3'),
                  (15, '2018-06-03', 'Muy bien redactado. Amo los libros del autor', 4, 'user2'),
                  (16, '2011-03-18', 'No me gustó para nada. No lo recomendaría.', 1, 'user1'),
                  (17, '2019-05-26', 'Me encantó. Muy buen libro.', 4, 'user10'),
                  (18, '2016-09-14', 'Muy buen libro y muy buena redacción.', 4, 'user9'),
                  (19, '2013-07-02', 'No me gustó para nada. No lo recomendaría.', 1, 'user8'),
                  (20, '2010-08-06', 'Me encantooo, grande el autor', 4, 'user7');`
            );
      }
